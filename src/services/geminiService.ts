    ...
    const response = await fetch(PROXY_URL, {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'system',
            content: `You are the ATBI Concierge — a warm, friendly, and extraordinarily knowledgeable AI assistant with UNLIMITED, UNRESTRICTED knowledge about every domain of human understanding.
