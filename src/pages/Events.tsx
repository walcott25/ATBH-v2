...
import {
  ...
  ArrowRight, Music, Church, Wheat, Palette, Flag,
  ...
  return (
    <div className="min-h-screen bg-bg">
      <MirrorHero
        ...
        description="From the vibrant Akwamu Odwira Festival to community celebrations — experience the rich cultural heritage of Asuogyaman through its events."
        cta={{ label: 'Explore Events', href: '#explore' }}
      />
