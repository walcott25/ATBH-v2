      ...
      >
        ...
        <div className="relative z-10 h-full flex flex-col justify-between p-10 md:p-16">
          ...
          <div className="space-y-8 max-w-md">
            ...
            >
              Sign in to continue exploring the beauty, culture, and adventure of Asuogyaman — where the Volta River meets untamed African splendor.
            </motion.p>
          </div>
            ...
            <SignIn
              ...
              appearance={{
                elements: {
                  ...
                  alternativeMethodsBlockButton: 'border border-white/10 text-white/70 hover:bg-white/5 hover:border-brand-gold/30 rounded-xl h-9 md:h-11 text-xs md:text-sm transition-all duration-300',
                  alternativeMethodsBlockButtonText: 'text-white/70 text-[10px] md:text-xs',
                }
              }}
            />
          </motion.div>
